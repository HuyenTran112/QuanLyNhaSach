...
GO
--TẠO KHÓA NGOẠI
ALTER TABLE KHACHHANG ADD CONSTRAINT FK_KHACHHANG_LOAIKHACHHANG  FOREIGN KEY(MALOAIKH) REFERENCES LOAIKHACHHANG(MALOAIKH)
GO
...
GO
ALTER TABLE PHANQUYEN ADD CONSTRAINT FK_PHANQUYEN_NHOM FOREIGN KEY (MANHOM) REFERENCES NHOM(MANHOM)
GO
