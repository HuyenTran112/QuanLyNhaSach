...
ALTER PROC SP_UPDATEDISTRIBUTOR
	...
	WHILE(@I<=@SOPHIEUNHAP_MAX)
		BEGIN
			IF(SELECT COUNT(*)
			 ...
			 SET @I=@I+1
		END
	IF(@I>@SOPHIEUNHAP_MAX)
		BEGIN
			SET @SOPHIEUNHAP=@SOPHIEUNHAP_MAX+1
			INSERT INTO PHIEUNHAP VALUES (@SOPHIEUNHAP,@NGAYNHAP_,@MACTY,0)
		END
END
GO
EXEC SP_INSERTBOOKSTOCK '1/1/2018',2
GO

SELECT * FROM PHIEUNHAP
--STORE PROC CẬP NHẬT PHIẾU NHẬP SÁCH
ALTER PROC SP_UPDATEBOOKSTOCK
