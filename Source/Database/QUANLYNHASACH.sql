...
BEGIN
	...
	SELECT TOP 10 WITH TIES SOHD, NGAYHD, MAKH, MANV, TRIGIA, TONGTIEN
	FROM HOADON
	WHERE @FROMDATE_ <= NGAYHD AND NGAYHD <= @TODATE_
...
EXEC SP_TOP20BOOK '13-12-2018', '23-12-2018'