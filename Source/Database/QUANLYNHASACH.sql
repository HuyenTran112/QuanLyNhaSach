...
EXEC SP_INSERTBILL '29-11-2018', 0, 1
...
END
GO
SELECT SOHD FROM HOADON ORDER BY SOHD DESC
select * from CTHD
...
SELECT TENNHOM 
	FROM NHOMNGUOIDUNG, NGUOIDUNG
	WHERE TENDANGNHAP='staff2' AND NHOMNGUOIDUNG.MANHOM=NGUOIDUNG.MANHOM
