...
public class fManagement extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(0, 0, 730, 320);

        jLabel2.setText("HOA");
        jDesktopPane1.add(jLabel2);
        jLabel2.setBounds(550, 100, 148, 53);

        jMenu1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/discount1.png"))); // NOI18N
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jDesktopPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 159, Short.MAX_VALUE)
        );
    ...
    private void jMenuItemReportRevenueActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemReportRevenueActionPerformed
        ...
        f.setSize(this.getSizeX(), this.getSizeY());
        f.getUserName(jMenu3.getText().toString());
        this.jDesktopPane1.add(f);
        f.setVisible(true);
